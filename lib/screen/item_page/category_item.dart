  ...
  final List<CategoryGroup> chiTienData = [
    ...
    CategoryGroup(
      ...
      tags: [
        ...
        Tag(
            name: "Nước", icon: FontAwesomeIcons.droplet, color: Colors.cyan
        ),
        Tag(
            name: "Điện", icon: FontAwesomeIcons.bolt, color: Colors.orange
        ),
        Tag(
            name: "Điện thoại", icon: FontAwesomeIcons.mobileScreen, color: Colors.blueGrey
        ),
        Tag(
            name: "Gas", icon: FontAwesomeIcons.fire, color: Colors.red
        ),
        Tag(name: "Thuê người", icon: FontAwesomeIcons.broom, color: Colors.purple),
        Tag(name: "Truyền hình", icon: FontAwesomeIcons.tv, color: Colors.amber),
      ],
      type: "Routine",
    ),
  ];
  ...
  Widget build(BuildContext context) {
    return DefaultTabController(
      ...
      child: Scaffold(
        ...
        appBar: AppBar(
          title: const Text("Chọn hạng mục", style: TextStyle(fontWeight: FontWeight.bold),),
          centerTitle: true,
          actions: [
            IconButton(
                onPressed: () {},
        ...
        body: Column(
          children: [
            ...
            // TabBarView phải nằm trong Expanded để chiếm hết không gian còn lại
            Expanded(
              child: TabBarView(
                children: [
